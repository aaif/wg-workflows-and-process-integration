...
Coordinates support [pattern selection](../selection/README.md) and comparison; they do not replace architecture review.
...
A [profile](../profiles/README.md) (`EP#`) names a region of this coordinate space (a typical whole-run arrangement). A [pattern](../patterns/README.md) (`WP##`) is a reusable sub-solution that occupies characteristic values on a few axes. The descriptor records a run's exact coordinate; the profile and patterns explain and justify it.
