...
- **Bound** — the iteration ceiling is a budget ([OV-06](../06-overlays/workflow-overlays.md))
...
- **Contained feedback** — repair feedback is treated as untrusted per
  [INV-018](../01-foundations/architecture-invariants.md); it may carry validator output
