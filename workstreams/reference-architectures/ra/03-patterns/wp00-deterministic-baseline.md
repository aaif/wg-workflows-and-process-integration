...
- Use as the default path; only escalate to a semantic pattern when a genuine
  inference need is demonstrated (see [design principles](../01-foundations/design-principles.md), DP-02).
...
- INV-016 / INV-017 — implementation-neutral and coded per the
  [classification model](../02-architecture-model/classification.md).
