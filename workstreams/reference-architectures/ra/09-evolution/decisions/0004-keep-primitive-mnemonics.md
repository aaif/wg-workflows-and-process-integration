...
The [primitive catalog](../../02-architecture-model/primitive-catalog.md) and [registry.yaml](../../../descriptor/registry.yaml) list the kept mnemonics plus `DLG`/`HND`. New primitives require justification ([DP-10](../../01-foundations/design-principles.md)).
