...
Every concept must carry a stable code and appear in [registry.yaml](../../../descriptor/registry.yaml) ([INV-017](../../01-foundations/architecture-invariants.md)). Headings must avoid embedding codes to keep anchors stable. A schema-validation step joins the quality gate.
