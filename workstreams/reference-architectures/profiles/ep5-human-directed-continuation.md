...
The signature is long-lived waiting on humans: `WAI` (wait) and `APR` (approval) over a [WP08 durable envelope](../patterns/README.md), governed by [OV-01 (human approval)](../overlays/workflow-overlays.md) and [OV-04 (durable wait)](../overlays/workflow-overlays.md).
...
- What is the authoritative record of *who* acted and on what version, and how does it feed [execution history](../foundations/core-concepts.md) ([OV-07](../overlays/workflow-overlays.md))?
