...
The defining move is `HND` (handoff) of a portable envelope realising [WP11 cross-runtime handoff](../patterns/README.md), which depends on a shared, versioned descriptor for interoperability. Bounded delegation across the seam is still governed by [INV-008](../foundations/architecture-invariants.md).
