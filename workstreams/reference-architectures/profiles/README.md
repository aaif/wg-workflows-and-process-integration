...
An **execution profile** (`EP#`) names a coherent whole-run arrangement of the five authorities and a characteristic region of the [classification coordinate](../model/classification.md). Where a [pattern](../patterns/README.md) is a reusable sub-solution, a profile describes how an *entire* workflow run is governed.
