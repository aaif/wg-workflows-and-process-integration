...
The prior `ra/ra-single-agent.md` and `ra/ra-multi-agent.md` scaffolds are repositioned as [profiles](../profiles/README.md) and converted to redirect stubs. All concepts are defined once and specialised via coordinates.
