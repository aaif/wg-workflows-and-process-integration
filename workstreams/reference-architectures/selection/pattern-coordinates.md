...
A workflow run is located at a **coordinate** across the eight [classification axes](../model/classification.md). The [wizard answers](wizard-questions.md) assemble that coordinate; the coordinate then suggests candidate [patterns](../patterns/README.md) and a [profile](../profiles/README.md). Coordinates support selection and comparison — they do not replace review.
...
This is exactly the design captured in [descriptor/examples/invoice-processing.wera.yaml](../descriptor/examples/invoice-processing.wera.yaml).
