...
- **[pattern-coordinates.md](pattern-coordinates.md)** — how the answers assemble into a [classification coordinate](../model/classification.md) and how coordinates map to candidate patterns/profiles.
